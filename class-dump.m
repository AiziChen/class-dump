    ...
    @autoreleasepool {
        ...
        while ( (ch = getopt_long(argc, argv, "aAC:f:HIo:rRsSt", longopts, NULL)) != -1) {
            switch (ch) {
                ...
                case 'C': {
                    NSError *error;
                    NSRegularExpression *regularExpression = [NSRegularExpression regularExpressionWithPattern:[NSString stringWithUTF8String:optarg] options:(NSRegularExpressionOptions)0 error:&error];
                ...
                case 'o':
                    ...
                    break;
                // frameworks and dylibs processing
                case 'r':
        ...
        // avoid costly autorelease pool drain, we’re exiting anyway
        exit(0);
    }
}
